...
$packagexml->setPackage('Text_Tokenizer');
$packagexml->setSummary('Interface for a Text_Tokenizer');
$packagexml->setDescription(<<<EOS
Text_Tokenizer defines the interface for a tokenizer class and the data model for a single token, usable when parsing text.
EOS
);
